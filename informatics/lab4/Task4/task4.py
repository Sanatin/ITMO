...
start = time.time()
for i in range(100):
   task0.xml_to_yaml('../schedule.xml', 'schedule.yaml')
end = time.time() - start
print(end)
...
start = time.time()
for i in range(100):
   task1.xml_to_yaml('../schedule.xml', 'schedule.yaml')
end = time.time() - start
print(end)
...
start = time.time()
for i in range(100):
   task2.xml_to_yaml('../schedule.xml', 'schedule.yaml')
end = time.time() - start
print(end)
...
start = time.time()
for i in range(100):
   task3.xml_to_yaml('../schedule.xml', 'schedule.yaml')
end = time.time() - start
print(end)
